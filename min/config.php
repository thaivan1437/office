 ...
 */
#$min_documentRoot = '';
#$exp = explode("/min",$_SERVER['REQUEST_URI']);
$min_documentRoot = $_SERVER['DOCUMENT_ROOT'].$folder."/";
#die($min_documentRoot);
#$min_documentRoot = $_SERVER['DOCUMENT_ROOT'].'/ngay/2016/6/mypham/';
...
$min_symlinks['//' . ltrim($sitePrefix, '/')] = $min_documentRoot;
           // echo "<pre>";print_r($min_symlinks);die;
/**
