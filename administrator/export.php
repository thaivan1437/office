...
$objPHPExcel->setActiveSheetIndex( 0 )->setCellValue( 'A'.$vitri, $i+1 )->setCellValue( 'B'.$vitri,$items[$i]['ten'] )->setCellValue( 'C'.$vitri, $items[$i]['soluong'])->setCellValue( 'D'.$vitri, number_format(get_price($items[$i]['id_sp']),0,".",",") )->setCellValue( 'E'.$vitri, number_format(get_price($items[$i]['id_sp'])*$items[$i]['soluong'],0,".",",") );
