...
function save_gioithieu() {
    ...
    if (empty($_POST))
        transfer("Không nhận được dữ liệu", "index.php?com=schema&act=capnhat");
	//dump($_POST);
    ...
    $d->setTable('schema');
    if ($d->update($data))
        header("Location:index.php?com=schema&act=capnhat");
    else
        transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=schema&act=capnhat");
}
