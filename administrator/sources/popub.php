...
function save_gioithieu(){
	...
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "index.php?com=popub&act=capnhat");
	...
	$d->setTable('popub');
	if($d->update($data))
		transfer("Dữ liệu được cập nhật", "index.php?com=popub&act=capnhat");
	else
		transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=popub&act=capnhat");
}
