...
function save_gioithieu() {
    ...
    if (empty($_POST))
        transfer("Không nhận được dữ liệu", "index.php?com=tambao&act=capnhat");
    ...
    $d->setWhere('id', '4');
    if ($d->update($data))
        transfer("Dữ liệu được cập nhật", "index.php?com=tambao&act=capnhat");
    else
        transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=tambao&act=capnhat");
}
