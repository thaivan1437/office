...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="index.php?com=product&act=man&type=<?=$_REQUEST["type"]?>"><span>sản phẩm</span></a></li>
				...
				<div class="formRight">
					<div class="selector">
						<select name="web" id="web">
							...
							<option value="lazada">Lazada.vn</option>
						</select>
					</div>
				</div>
				<div class="clear"></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		var lazada={
			id_content:".right_content",
			id_ten_sp_content:".ten-sp-ct",
			id_hinh_ct:".img-thumb-ct",
			id_sp:".list-sp li",
			id_content_ct:".right_content",
			id_ten_sp:"h1",
			id_ma_sp:"",
			id_gia_sp:"#special_price_box",
			id_giakm_sp:"price_box",
			tiente:"VND",
			id_hinh_sp:"#fancy_pro_img",
			id_mota_sp:".product-infos p",
			id_nd_sp:".description",
			link_define:"",
			vitrihinh:0,
		};
		//console.log(lazada);
			...
			$("#tbl tr").each(function(){	
				...
				if($obj.find("a").length){
					if($obj.find("input[type=checkbox]").is(":checked")){
						...
						jQuery.ajaxQueue({
							url:base_url+"/administrator/index.php?com=<?=$_GET['com']?>&type=<?=$_REQUEST['type']?>&act=get&method=get-item",
