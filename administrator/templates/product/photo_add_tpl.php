...
<form name="frm" method="post" action="index.php?com=product&act=save_photo&idc=<?= $_REQUEST['idc'] ?>&type1=<?= $_REQUEST['type1'] ?>" enctype="multipart/form-data" class="nhaplieu">
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location = 'index.php?com=product&idc=<?= $_REQUEST['idc'] ?>&act=man_photo&type1=<?= $_REQUEST['type1'] ?>'" class="btn" />
</form>