...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=user&act=man_cat"><span>Danh sách nhóm</span></a></li>
                                    <li class="current"><a href="#" onclick="return false;">Chỉnh sửa nhóm</a></li>
        </ul>
        <div class="clear"></div>
    </div>
</div>
<form name="supplier" id="validate" class="form" action="index.php?com=user&act=save_cat" method="post" enctype="multipart/form-data">
	<div class="widget">
