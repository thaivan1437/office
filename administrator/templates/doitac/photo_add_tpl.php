...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="index.php?com=doitac&act=man_photo&type=<?=$_REQUEST["type"]?>"><span>Hình ảnh</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=doitac&act=save_photo&type=<?=$_REQUEST["type"]?>&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div id="info" class="tab_content">
			...
			<div class="formRow">
				...
				<div class="formRight">
					...
					<!--<a title="Xoá ảnh" href="index.php?com=doitac&act=delete_img&id=<?=@$item['id']?>">Xoá ảnh</a>-->
					<br>
					<?php }?>
