...
<script type="text/javascript">
    ...
    function js_submit() {
		...
		if (hoi == true)
			//document.location = "index.php?com=dknhantin&act=guitin&listid=" + listid;
		...
		<tbody>
			...
			<tr>
				...
				<td class="title_name_data">
					<a href="index.php?com=dknhantin&act=edit&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST["type"]?>" class="tipS SC_bold">
						<?=$items[$i]["email"]?>
					</a>
				</td>
		   
				<!--<td class="actBtns">
					<a href="index.php?com=dknhantin&act=edit&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST["type"]?>" title="" class="smallButton tipS" original-title="Sửa sản phẩm"><img src="./images/icons/dark/pencil.png" alt=""></a>
					<a href="" onclick="CheckDelete('index.php?com=dknhantin&act=delete&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST["type"]?>'); return false;" title="" class="smallButton tipS" original-title="Xóa sản phẩm"><img src="./images/icons/dark/close.png" alt=""></a>
				</td>-->
			</tr>
			<?php } ?>
		</tbody>
