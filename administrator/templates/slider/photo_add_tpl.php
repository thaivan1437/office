...
<form name="supplier" id="validate" class="form" action="index.php?com=slider&act=save_photo&type=<?=$_REQUEST["type"]?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<br>
				<?php }?>
				<input type="file" id="file<?=$i?>" name="file<?=$i?>" /><img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)"> Width: 1366px & height: 450px;
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
