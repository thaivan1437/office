	...
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<br>
				<?php }?>
				<input type="file" id="file" name="file" /><img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)">Width: 1366px & height: 450px;
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
