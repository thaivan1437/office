...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="index.php?com=footer&act=capnhat"><span>Thông tin footer</span></a></li>
        <li class="current"><a href="#" onclick="return false;">Cập nhật</a></li>
        </ul>
        <div class="clear"></div>
    </div>
</div>
<form name="supplier" id="validate" class="form" action="index.php?com=footer&act=save" method="post" enctype="multipart/form-data">
	<div class="widget">
