...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
        ...
        <input type="button" class="blueB" value="Hiện" onclick="ChangeAction('index.php?com=place&act=man_ward&multi=show');return false;" />
        <input type="button" class="blueB" value="Ẩn" onclick="ChangeAction('index.php?com=place&act=man_ward&multi=hide');return false;" />
        ...
        <td align="center">
           <?php 
			if(@$items[$i]['hienthi']==1)
				{
		?>
            <a href="index.php?com=place&act=man_ward&hienthi=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
            <?php } else { ?>
         <a href="index.php?com=place&act=man_ward&hienthi=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/hide.png" alt=""></a>
         <?php } ?>
        </td>
