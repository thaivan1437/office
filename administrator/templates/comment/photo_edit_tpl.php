...
<form name="frm" method="post" action="default.php?com=product&act=save_photo&id=<?= $_REQUEST['id']; ?>&idc=<?= $_REQUEST['idc'] ?>" enctype="multipart/form-data" class="nhaplieu">
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location = 'default.php?com=product&act=man_photo'" class="btn" />
</form>