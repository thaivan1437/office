...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
    	<input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=video&act=add'" />
        <input type="button" class="blueB" value="Hiện" onclick="ChangeAction('index.php?com=video&act=man&multi=show');return false;" />
        <input type="button" class="blueB" value="Ẩn" onclick="ChangeAction('index.php?com=video&act=man&multi=hide');return false;" />
        <input type="button" class="blueB" value="Xoá" onclick="ChangeAction('index.php?com=video&act=man&multi=del');return false;" />
    </div>  
       ...
       <td>
        ...
        <td align="center">
				...
				<td class="title_name_data">
					<a href="index.php?com=video&act=edit&id=<?=$items[$i]['id']?>" class="tipS SC_bold">
						<?=$items[$i]['ten_vi']?>
					</a>
				</td>
				...
				<td class="actBtns">
					<a href="index.php?com=video&act=edit&id=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Sửa Video"><img src="./images/icons/dark/pencil.png" alt=""></a>
					<a href="" onclick="CheckDelete('index.php?com=video&act=delete&id=<?=$items[$i]['id']?>'); return false;" title="" class="smallButton tipS" original-title="Xóa Video"><img src="./images/icons/dark/close.png" alt=""></a>
				</td>
			</tr>
			<?php } ?>
		</tbody>
