...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=post&act=mam"><span>bài viết</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=post&act=save&curPage=<?=$_REQUEST['curPage']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                    ...
                    <a title="Xoá ảnh" href="index.php?com=post&act=delete_img&id=<?=@$item['id']?>">Xoá ảnh</a>
                    <br>
                    <?php }?>
