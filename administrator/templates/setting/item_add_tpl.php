<script src="https://maps.google.com/maps?file=api&amp;v=2&amp;key=AIzaSyB2sl3FBhhDw2JFbKXBQkl2qQP9bzr_FVA"
    ...
    <div class="widget">
		...
		<div id="content_lang_2<?=$key?>" class="tab_content">       	   
			...
			<div class="formRow">
				<label>Slogan</label>
				<div class="formRight">
					<input type="text" value="<?=(@$item['slogan_'.$key])?>" name="slogan_<?=$key?>" title="Nhập slogan công ty" class="tipS" />
				</div>
				<div class="clear"></div>
			</div>
		</div>
		...
		<div class="formRow">
			...
			<div class="formRight">
				<div class="selector">
					<select name="donvi">
						<option value="1" <?=($item["donvi"]==1) ? "selected" : "";?>>USD</option>
						<option value="2" <?=($item["donvi"]==2) ? "selected" : "";?>>VNĐ</option>
					</select>
				</div>
			</div>
			<div class="clear"></div>
		...
		<div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['tigia']?>" name="tigia" title="Nhập tỉ giá USD" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="formRight">
             <?php if ($_REQUEST['act']=='capnhat' && $item['photo']!='' ) { ?>
				...
				<input type="file" id="file" name="file3" /> <img src="./images/question-button.png" alt="Upload favicon" class="icon_question tipS" original-title="Tải hình đại diện website (ảnh JPEG, GIF , JPG , PNG)">
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
	   ...
	   <?php 
		...
		<div id="content_lang_3<?=$key?>" class="tab_content">       	 
			...
			<div class="formRow">
				<label>Thẻ H6</label>
				<div class="formRight">
					<input type="text" value="<?=@$item['h6_'.$key]?>" name="h6_<?=$key?>" title="Nội dung thẻ h6 dùng để SEO" class="tipS" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
