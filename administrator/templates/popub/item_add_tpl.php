...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="index.php?com=popub&act=man&type=<?=$_REQUEST["type"]?>"><span>Quản lý popub</span></a></li>
        <li class="current"><a href="#" onclick="return false;">Thêm</a></li>
        </ul>
        <div class="clear"></div>
    </div>
</div>
<form name="supplier" id="validate" class="form" action="index.php?com=popub&act=save&type=<?=$_REQUEST["type"]?>&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div id="info" class="tab_content">
			...
			<div class="formRow">
				...
				<div class="formRight">
					...
					<!--<a title="Xoá ảnh" href="index.php?com=popub&act=delete_img&id=<?=@$item['id']?>">Xoá ảnh</a>-->
					<br>
					<?php }?>
