...
$(function () {
    $('#container').highcharts({
        ...
        subtitle: {
            text: 'Devetloper by : <a href="http://ibrandmedia.vn">Ibrand media</a>'
        },
        xAxis: {
            type: 'category',
            labels: {
...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Powered by <a href="http://ibrandmedia.vn" target="_blank"><span style="color:#f00;">Ibrand media</span></a></h6><div class="clear"></div></div>
