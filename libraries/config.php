...
$config['author']['name'] = 'Phạm Duy Tâm Vinh';
$config['author']['email'] = 'tamvinh.nina@gmail.com';
$config['author']['timefinish'] = '08/2016';
...
$config['database']['username'] ='cityoffice_thue';#Tên đăng nhập database
$config['database']['password'] = 'Dung@<>12345';#Mật khẩu đăng nhập database
$config['database']['database'] = 'cityoffice_thue';#Tên database
...
$iphost = '127.0.0.1';
$userhost = 'info@thuevanphongnhanh.com';
$passhost = 'Dung@<>12345';
?>