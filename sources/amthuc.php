...
if (isset($_GET['id'])) {
    ...
    $sql = "select ten_$lang as ten,mota_$lang as mota,noidung_vi as noidung,ngaytao,title_$lang as title,keywords_$lang as keywords,description_$lang as description, photo, h1, h2, h3 from #_$table where hienthi=1 and id='" . $id . "'";
    $d->query($sql);
	...
	$arr_breakcumb[2]=array("url"=>"http://".$config_url."/".$com."/".$tintuc_detail[0]["tenkhongdau"]."-".$tintuc_detail[0]["id"].".html","name"=>$tintuc_detail[0]["ten"]);
	//share
